...
export default function CqcSection() {
  return (
    <section
      className={`border-y border-neutral-100 bg-[#faf8f4] ${sectionPy}`}
    ...
    >
      <div className={`${containerClass} grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-14`}>
        <div>
          ...
          <p className="mt-5 max-w-xl text-base leading-[1.85] text-neutral-600 sm:text-lg sm:leading-relaxed">
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="w-full max-w-sm rounded-lg border border-neutral-200 bg-white p-8 shadow-sm">
            ...
            <p
              className="mt-4 text-center text-xs font-medium uppercase tracking-wide text-neutral-500"
              style={serif}
            >
              Overall rating
            </p>
