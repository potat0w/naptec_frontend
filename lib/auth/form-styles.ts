export const formInputClass =
  "w-full rounded-2xl border border-surface-card bg-white px-5 py-3 text-sm text-neutral-900 shadow-[0_1px_2px_rgba(63,45,98,0.05)] outline-none transition-[border-color,box-shadow] placeholder:text-neutral-400 focus:border-brand focus:ring-2 focus:ring-brand/12";
...
export const formTextareaClass =
  "w-full resize-y rounded-2xl border border-surface-card bg-white px-5 py-3 text-sm text-neutral-900 shadow-[0_1px_2px_rgba(63,45,98,0.05)] outline-none transition-[border-color,box-shadow] placeholder:text-neutral-400 focus:border-brand focus:ring-2 focus:ring-brand/12";

export const formLabelClass = "mb-1 block text-sm font-medium text-body";
...
export const formSectionSubtitleClass = "mt-1.5 text-sm text-muted";
