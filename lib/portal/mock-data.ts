...
export const reports: CareReport[] = [
  {
    ...
    organizedReport:
      "Clinical Summary\nVisit completed without incident. Patient remained comfortable throughout the shift with routine care delivered as planned.\n\nTimeline\n1. Medication administered at 8:00 AM\n2. Patient nutrition and meal support documented during the scheduled visit\n3. Mobility assistance provided during the scheduled visit\n4. Vital signs monitored — blood pressure within expected range\n\nFollow-up\nContinue monitoring per care plan. Escalate to clinical lead if any concerns arise.",
    status: "submitted",
  ...
  },
  {
    ...
    organizedReport:
      "Clinical Summary\nVisit completed without incident. Patient remained comfortable throughout the shift with routine care delivered as planned.\n\nTimeline\n1. Patient nutrition and meal support documented during the scheduled visit\n2. Medication administered during the scheduled visit\n3. Personal care and hygiene support completed\n4. Emotional wellbeing observed and documented\n\nFollow-up\nContinue monitoring per care plan.",
    status: "reviewed",
  ...
  },
  {
    ...
    organizedReport:
      "Clinical Summary\nVisit completed without incident.\n\nTimeline\n1. Mobility assistance provided during the scheduled visit\n2. Patient nutrition and meal support documented during the scheduled visit\n\nFollow-up\nContinue monitoring per care plan.",
    status: "pending",
